...
const reportsByCase: Record<ExampleCaseId, CardioReport> = {
  NEEDS_MORE_INFO: {
    ok: true,
    errors: [],
    ...
    decision: {
      ...
      clinical_summary:
        "Critical cardio fields missing; safe routing deferred.",
      required_fields: [
      ...
      required_actions: [
        "Collect all listed missing critical fields and resubmit.",
      ],
      recommendations: [],
      reasons: [],
      flags: [],
  ...
  ROUTINE_REVIEW: {
    ...
    decision: {
      ...
      clinical_summary:
        "Stable complete case; routine review indicated by deterministic rules.",
      required_fields: [],
      missing_fields: [],
      required_actions: ["Schedule routine cardiology review."],
      recommendations: [],
      reasons: [
        "No emergency or urgent cluster detected in complete case.",
      ],
      flags: [],
    },
    safety: {
  ...
  EMERGENCY_ROUTE: {
    ...
    decision: {
      ...
      clinical_summary:
        "Hard emergency red-flag criteria met; emergency route required.",
      required_fields: [],
      missing_fields: [],
      required_actions: [
        "Initiate immediate emergency escalation protocol.",
      ],
      recommendations: [],
      reasons: [],
    ...
    trace: {
      policy_trace: {
        ...
        triggered: ["POLICY_SYNCOPAL_CHEST_PAIN_V1"],
      },
      rules_evaluated: rulesEvaluated,
      rules_triggered: ["RULE_ROUTINE_STABLE_COMPLETE_V1"],
      activated_rules: [
  ...
  DEFERRED_PENDING_DATA: {
    ...
    decision: {
      ...
      urgency_level: "UNKNOWN",
      clinical_summary:
        "Conflicting structured cardio inputs detected; safe routing deferred.",
      required_fields: [],
      missing_fields: [],
      required_actions: [
...
export function getMockReport(caseId: ExampleCaseId): CardioReport {
  return structuredClone(reportsByCase[caseId]);
}
